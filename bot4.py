...
# connect to reddit 
reddit = praw.Reddit('bot4', user_agent='natnatbotbot')
...
while True:
    ...
    try:
        ...
        print("LIST GENERATOR THROWN, NEW SUBMISSION")
    ...
    for comment in all_comments:
        if str(comment.author) != 'natnatbotbot':
    ...
    if has_not_commented:
        ...
        try:
            ...
            print("comment without replies is empty")
        try:
